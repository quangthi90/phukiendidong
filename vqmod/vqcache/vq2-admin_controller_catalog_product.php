...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				$action[] = array(
					...
					'href' => $this->url->link('catalog/barcode', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL')
				);
  	...
  	private function getForm() {
		...
		$this->data['text_choose_label'] = $this->language->get('text_choose_label');
		...
		*/
		...
		foreach ($attribute_groups as $attribute_group) {
			$attributes = $this->model_catalog_attribute->getAttributesByAttributeGroupId(array('filter_attribute_group_id' => $attribute_group['attribute_group_id']));
			$this->data['attribute_groups'][] = array(
		...
		*/
		...
		$this->data['labels'] = $this->model_catalog_label->getLabels(array('status' => 1));
		if (isset($this->request->post['product_label'])) {
			$this->data['product_label'] = $this->request->post['product_label'];
		}elseif (isset($this->request->get['product_id'])) {
			$this->data['product_label'] = $this->model_catalog_product->getProductLabel($this->request->get['product_id']);
		}else {
			$this->data['product_label'] = '';
		}
