...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content">
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <label for="sub_category" style="margin-top: 3px;"><?php echo $text_sub_category; ?></label>
        </div>
      </div>      
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <label for="description" style="margin-top: 3px;"><?php echo $entry_description; ?></label>
        </div>
      </div>
