...
<h2 class='ac-title'><?php echo $heading_title; ?></h2> 
  ...
  <table class="list order_lst">
    <thead>
      <tr>
        ...
        <td style="text-align: right;"><?php echo $column_quantity; ?></td>
        <td style="text-align: right;"><?php echo $column_price; ?></td>
        <td style="text-align: right;"><?php echo $column_total; ?></td>
        <?php if ($products) { ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="text-align: right;"><a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
      </tr>
      <?php } ?>
  ...
  <?php } ?>
  <?php if ($histories) { ?>
  <h2 class='ac-title'><?php echo $text_history; ?></h2>
  <table class="list order_lst">
    <thead>
      <tr>
  ...
  <?php } ?>
  <div class="buttons">
    <div style="text-align: right;"><a href="<?php echo $continue; ?>" class="button"><?php echo $button_continue; ?></a></div>
  </div>
