...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/cart_not_found.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/error/cart_not_found.tpl';
			} else {
				$this->template = 'default/template/error/cart_not_found.tpl';
			}
