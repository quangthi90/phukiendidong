...
class ControllerCheckoutCheckout extends Controller { 
	public function index() {
		...
		$this->data['text_order_infor'] = $this->language->get('text_order_infor');
		$this->data['text_total_and_shipping'] = $this->language->get('text_total_and_shipping');
		...
		$this->data['updateCart'] = $this->url->link( 'checkout/step3/updateCart' );
		$this->data['reloadCart'] = $this->url->link( 'checkout/step3/reloadCart' );
