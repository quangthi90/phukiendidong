  	...
  	private function getList() {
    	...
    	foreach ($results as $result) {
    		...
    		//} else {
				...
				//$format = $this->language->get('entry_fullname') . '{firstname} {lastname}' . "\n" . $this->language->get('entry_company') . '{company}' . "\n" . $this->language->get('entry_address_1') . '{address_1}' . "\n" . $this->language->get('entry_address_2') . '{address_2}' . "\n" . $this->language->get('entry_postcode') . '{postcode}' . "\n" . $this->language->get('entry_zone') . '{zone}' . "\n" . $this->language->get('entry_country') . '{country}';
			//}
			...
			$address = array(
				array( 
					'text' => $this->language->get('entry_fullname'),
				...
				array( 
					'text' => $this->language->get('entry_address_1'),
					'value' => $result['address_1'],
					),
				array( 
					'text' => $this->language->get('entry_address_2'),
