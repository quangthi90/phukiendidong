...
class ControllerAccountWishList extends Controller {
	public function index() {
		...
		$this->data['continue'] = HTTP_SERVER . 'thong-tin-tai-khoan';
	...
	public function add() {
		...
		if ($product_info) {
			...
			if ($this->customer->isLogged()) {			
				...
				$json['success'] = sprintf($this->language->get('text_login'), HTTP_SERVER . 'dang-nhap', HTTP_SERVER . 'dang-ky', $this->url->link('product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('account/wishlist'));				
			}
