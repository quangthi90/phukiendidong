...
class ModelCatalogReview extends Model {		
	...
	public function getReviewsByProductId($product_id, $start = 0, $limit = 20) {
		$query = $this->db->query("
			SELECT r.review_id, r.rating, r.text, 
				p.product_id, pd.name, p.price, p.image, r.date_added, r.customer_id 
			FROM " . DB_PREFIX . "review r LEFT JOIN " . DB_PREFIX . "product p 
				ON (r.product_id = p.product_id) LEFT JOIN " . DB_PREFIX . "product_description pd 
