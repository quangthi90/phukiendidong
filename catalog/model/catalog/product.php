...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$label_data = $this->db->query("SELECT * FROM " . DB_PREFIX . "label l LEFT JOIN " . DB_PREFIX . "label_description ld ON (l.label_id = ld.label_id) WHERE ld.language_id = '" . $this->config->get('config_language_id') . "' AND l.label_id = '" . $query->row['label'] . "'");
			if ($label_data->num_rows) {
				$query->row['label_title'] = $label_data->row['title'];
				$query->row['label_image'] = $label_data->row['image'];
			}else {
				$query->row['label_title'] = '';
				$query->row['label_image'] = '';
			}
