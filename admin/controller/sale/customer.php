	...
	public function approve() {
  	...
  	private function getForm() {
		...
		$this->data['entry_points'] = $this->language->get('entry_points');
 		...
 		$this->data['entry_birthday'] = 'Ngày sinh <br /> Format: yyyy/mm/dd';
...
//		}
    	...
    	} elseif (!empty($customer_info) && !empty($customer_info['birthday'])) {
			$this->data['birthday'] = date('Y/m/d', $customer_info['birthday']);
		} else {
      		$this->data['birthday'] = '';
    	}
