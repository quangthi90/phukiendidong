...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_slide_manager'] = $this->language->get('text_slide_manager');
		...
		//------------------------- Add code --------------------------
      	// News
      	$this->data['text_information'] = $this->language->get('text_information');
      	$this->data['text_infor_category'] = $this->language->get('text_infor_category');
      	$this->data['text_infor_manage'] = $this->language->get('text_infor_manage');
      	$this->data['text_banner_manager'] = $this->language->get('text_banner_manager');
      	$this->data['text_limit_manager'] = $this->language->get('text_limit_manager');
      	$this->data['text_dynamic_banner'] = $this->language->get('text_dynamic_banner');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['label'] = $this->url->link('catalog/label', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['slide_manager'] = $this->url->link('module/slideshow', 'token=' . $this->session->data['token'], 'SSL');
			...
			// News
			$this->data['infor_category'] = $this->url->link('news/category', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['infor_detail'] = $this->url->link('news/news', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['comment_detail'] = $this->url->link('news/comment', 'token=' . $this->session->data['token'], 'SLL');
			$this->data['banner_manager'] = $this->url->link('design/banner_manager', 'token=' . $this->session->data['token'], 'SLL');
			$this->data['limit_manager'] = $this->url->link('extension/limit_manager', 'token=' . $this->session->data['token'], 'SLL');
			$this->data['email_manager'] = $this->url->link('sale/email_manager', 'token=' . $this->session->data['token'], 'SLL');
			$this->data['dynamic_banner'] = $this->url->link('module/carousel', 'token=' . $this->session->data['token'], 'SLL');
			...
			$this->data['text_email_manager'] = 'Quản lí Thư điện tử (' . $this->model_sale_contact->getTotalContacts(array('review' => 0)) . ')';	

			// product review
			$this->load->model('catalog/review');
			$this->data['text_review'] = $this->language->get('text_review') . ' (' . $this->model_catalog_review->getTotalReviews(array('review' => 0)) . ')';

			// news comment	
			$this->load->model('news/comment');
			$this->data['text_comment'] = $this->language->get('text_comment') . ' (' . $this->model_news_comment->getTotalComments(array('review' => 0)) . ')';
		}
