          ...
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
                ...
                <td>
                  <select name="sex">
                    <?php if ($sex == 1) { ?>
                      ...
                      <option value="1" select="selected"><?php echo $text_female; ?></option>
                      <option value="2"><?php echo $text_other; ?></option>
                    <?php }elseif ($sex == 2) { ?>
                      <option value="0"><?php echo $text_male; ?></option>
                      <option value="1"><?php echo $text_male; ?></option>
                      <option value="2" select="selected"><?php echo $text_male; ?></option>
                    <?php }else { ?>
                      <option value="0" select="selected"><?php echo $text_male; ?></option>
              ...
              <tr>
                ...
                <td><input type="text" name="birthday" value="<?php echo $birthday; ?>" class="date" />
              </tr>
              <tr>
