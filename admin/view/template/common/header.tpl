...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="information"><a class="top"><?php echo $text_information; ?></a>
        <ul>
          <li><a href="<?php echo $infor_category; ?>"><?php echo $text_infor_category; ?></a></li>
          <li><a href="<?php echo $infor_detail; ?>"><?php echo $text_infor_manage; ?></a></li>
          <li><a href="<?php echo $comment_detail; ?>"><?php echo $text_comment; ?></a></li>
        </ul>
      </li>
      <li id="extension">
        <a class="top"><?php echo $text_extension; ?></a>
        <ul>
          <li><a href="<?php echo $banner_manager; ?>"><?php echo $text_banner_manager; ?></a></li>
          <li><a href="<?php echo $dynamic_banner; ?>"><?php echo $text_dynamic_banner; ?></a></li>
          <li><a href="<?php echo $limit_manager; ?>"><?php echo $text_limit_manager; ?></a></li>
          <li><a href="<?php echo $slide_manager; ?>"><?php echo $text_slide_manager; ?></a></li>
        </ul>
      </li>
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $email_manager; ?>"><?php echo $text_email_manager; ?></a></li>
