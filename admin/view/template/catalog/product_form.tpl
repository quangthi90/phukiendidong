...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a></div>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <!--<tr>
                ...
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" id="meta_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>//-->
              <tr>
                <td><?php echo $entry_meta_description; ?></td>
                <td>
                  <?php if (isset($product_description[$language['language_id']]['meta_description']) && $product_description[$language['language_id']]['meta_description']) { ?>

                  <?php if (is_array($product_description[$language['language_id']]['meta_description'])) { ?>

                  <?php foreach ($product_description[$language['language_id']]['meta_description'] as $meta_description) { ?>
                  <div class="meta_description_layout<?php echo $language['language_id']; ?>"><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_description][]" value="<?php echo $meta_description; ?>" /> [<a onclick="addMoreMetaDescription(this, <?php echo $language['language_id']; ?>);">Thêm</a>] [<a onclick="deleteMetaDescription(this, <?php echo $language['language_id']; ?>);">Xóa</a>]</div>
                  <?php } ?>

                  <?php }else { ?>

                  <?php foreach (unserialize(str_replace('\\', '', $product_description[$language['language_id']]['meta_description'])) as $meta_description) { ?>
                  <div class="meta_description_layout<?php echo $language['language_id']; ?>"><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_description][]" value="<?php echo $meta_description; ?>" /> [<a onclick="addMoreMetaDescription(this, <?php echo $language['language_id']; ?>);">Thêm</a>] [<a onclick="deleteMetaDescription(this, <?php echo $language['language_id']; ?>);">Xóa</a>]</div>
                  <?php } ?>
                  ...
                  <?php }else { ?>
                  <div class="meta_description_layout<?php echo $language['language_id']; ?>"><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_description][]" /> [<a onclick="addMoreMetaDescription(this, <?php echo $language['language_id']; ?>);">Thêm</a>] [<a onclick="deleteMetaDescription(this, <?php echo $language['language_id']; ?>);">Xóa</a>]</div>
                  <?php } ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <select name="product_label">
                    <option value="0"><?php echo $text_choose_label; ?></option>
                  <?php foreach ($labels as $label) { ?>
                    <option value="<?php echo $label['label_id']; ?>" <?php echo ($product_label == $label['label_id']) ? 'selected="selected"' : ''; ?>><?php echo $label['title']; ?></option>
                  <?php } ?>
                  </select>
                </td>
              </tr>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                <td class="left">
                  <?php $attribute_group_data = array(); ?>
                  <select name="product_attribute[<?php echo $attribute_row; ?>][attribute_group_id]" onchange="changeGroup(<?php echo $attribute_row; ?>);">
                  <?php foreach ($attribute_groups as $attribute_group) { ?>
                    <option value="<?php echo $attribute_group['attribute_group_id']; ?>" <?php if ($product_attribute['attribute_group_id'] == $attribute_group['attribute_group_id']) {echo 'selected'; $attribute_group_data = $attribute_group; } ?> ><?php echo $attribute_group['name']; ?></option>
                  <?php } ?>
                  </select>
                  <?php if ($attribute_group_data['attribute_group_id'] == $product_attribute['attribute_group_id']) { ?>
                  <select name="product_attribute[<?php echo $attribute_row; ?>][attribute_id]">
                    <?php foreach ($attribute_group_data['attributes'] as $attribute) { ?>
                      <option value="<?php echo $attribute['attribute_id']; ?>" <?php if ($product_attribute['attribute_id'] == $attribute['attribute_id']) echo 'selected'; ?>><?php echo $attribute['name']; ?></option>
                    <?php } ?>
                  </select>
                  <?php } ?>
                </td>
...
<script type="text/javascript">
                  function addMoreMetaDescription(element, language) {
                    $(element).parent().after('<div class="meta_description_layout' + language +'"><input type="text" name="product_description[' + language + '][meta_description][]" /> [<a onclick="addMoreMetaDescription(this,' + language + ');">Thêm</a>] [<a onclick="deleteMetaDescription(this, ' + language + ');">Xóa</a>]</div>');
                  }
                  function deleteMetaDescription(element , language) {
                    if ($(".meta_description_layout" + language).length > 1) {
...
function addAttribute() {
  html  = '<tbody id="attribute-row' + attribute_row + '">';
    html += '  <tr>';
  html += '    <td class="left"><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" />';
  html += '<select name="product_attribute[' + attribute_row + '][attribute_group_id]" onchange="changeGroup(' + attribute_row + ')" >';
  html += '<option>Chọn nhóm thuộc tính</option>';
  <?php foreach ($attribute_groups as $attribute_group) { ?>
  html += "<option value=<?php echo $attribute_group['attribute_group_id']; ?> ><?php echo $attribute_group['name']; ?></option>";
  <?php } ?>
  html += '</select>';
  html += '<select name="product_attribute[' + attribute_row + '][attribute_id]">';
  html += '<option>Chọn nhóm thuộc tính</option>';
  html += '</select>';
  html += '</td>';
  html += '    <td class="left">';
...
function changeGroup(attribute_row) {
  var attribute_group_id = $("select[name=\'product_attribute[" + attribute_row + "][attribute_group_id]\']").val();
  $("select[name=\'product_attribute[" + attribute_row + "][attribute_id]\']").after('<span class="mess">loading...</span>');
  $.ajax({
    url: 'index.php?route=catalog/attribute/loadattributebygroup&token=<?php echo $token; ?>&attribute_group_id=' + attribute_group_id,
    dataType: 'json',
    success: function(json) {
      if (json.status == 'success') {
        html = '';
        for (x in json.data) {
          html += '<option value="' + json.data[x]['attribute_id'] + '">' + json.data[x]['name'] + '</option>';
        }
        $("select[name=\'product_attribute[" + attribute_row + "][attribute_id]\']").html(html);
        $('.mess').remove();
      }
    }
  });
